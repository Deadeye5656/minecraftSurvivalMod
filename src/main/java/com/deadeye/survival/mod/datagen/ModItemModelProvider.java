...
//        basicItem(ModItems.CHISEL.get());
        ...
        trimmedArmorItem(ModItems.DAVITE_HELMET);
        trimmedArmorItem(ModItems.DAVITE_CHESTPLATE);
        trimmedArmorItem(ModItems.DAVITE_LEGGINGS);
        trimmedArmorItem(ModItems.DAVITE_BOOTS);
    }
