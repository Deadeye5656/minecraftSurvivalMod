package com.deadeye.survival.mod.entity.custom;
...
public class TriceratopsEntity extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Player.class, 30.0F, 3.0D, 3.5D));
        this.goalSelector.addGoal(2, new PanicGoal(this, 2.0));
        this.goalSelector.addGoal(3, new BreedGoal(this, 1.0));
        this.goalSelector.addGoal(4, new TemptGoal(this, 1.25, stack -> stack.is(ModItems.KOHLRABI.get()), false));
